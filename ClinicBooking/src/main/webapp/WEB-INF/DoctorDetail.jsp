                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a
                                        href="${pageContext.request.contextPath}/manage-my-appointments">Manage
                                        My
                                        Appointments</a></li>
                            ...
                            <div class="review-item">
                                <div class="reviewer-info">
                                    <div class="reviewer-avatar">
                                        ${fn:substring(review.reviewer.fullName, 0, 1)}
                                    </div>
                                    <div class="reviewer-details">
                                        <p class="reviewer-name">${review.reviewer.fullName}</p>
                                        <div class="review-meta">
                                            ...
                                            <span class="review-date">
                                                <fmt:formatDate value="${review.dateCreate}"
                                                                pattern="MMM dd, yyyy" />
                                            </span>
                                        </div>
                                    </div>
