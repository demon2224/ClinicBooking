<%-- Document : DoctorDetail Created on : Oct 10, 2025, 12:46:40 PM Author : Nguyen Minh Khang - CE190728 --%>
            ...
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                    ...
                    <body>
                                ...
                                <div class="doctor-header">
                                    ...
                                    <div class="doctor-main-info">
                                        ...
                                        <div class="doctor-info">
                                            ...
                                            <!-- Qualifications & Degrees (Moved here) -->
                                            <c:if test="${not empty degrees}">
                                                <div style="margin: 1.5rem 0;">
                                                    <h4
                                                        style="color: #2c3e50; font-size: 1.1rem; margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem;">
                                                        <i class="fas fa-graduation-cap" style="color: #175cdd;"></i>
                                                        Qualifications
                                                    </h4>
                                                    <c:forEach var="degree" items="${degrees}">
                                                        <div
                                                            style="display: flex; align-items: center; padding: 0.5rem 0; border-bottom: 1px solid #f1f3f4;">
                                                            <div style="margin-right: 0.8rem; color: #28a745;">
                                                                <i class="fas fa-certificate"></i>
                                                            </div>
                                                            <div style="flex: 1;">
                                                                <div
                                                                    style="font-weight: 600; color: #2c3e50; font-size: 0.95rem; margin-bottom: 0.2rem;">
                                                                    ${degree.degreeName}
                                                                </div>
                                                                <div style="color: #6c757d; font-size: 0.85rem;">
                                                                    <i class="fas fa-university"
                                                                        style="margin-right: 0.3rem;"></i>${degree.grantor}
                                    ...
                                    <div class="doctor-side-info">
                                        ...
                                        <div class="side-info-item">
                                            ...
                                            <span class="side-info-value" style="color: #28a745;">
                        ...
                        </div> <!-- Reviews Section - Only show if reviews data is available -->
