...
public class ReceptionistManageAppointmentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReceptionistManageAppointment</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ReceptionistManageAppointment at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ("cancel".equals(action)) {
                ...
                if (success) {
                    request.getSession().setAttribute("successMessage", "Appointment update successfully!");
                    response.sendRedirect(request.getContextPath() + "/receptionist-manage-appointment");
                } else {
