...
//        processRequest(request, response);
    ...
    private void handleCreateResponse(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (!isValidMedicineName
            ...
            boolean createResult = medicineDAO.createNewMedicine(medicineNameParam, medicineCodeParam.toUpperCase(), medicineTypeParam, (Double.parseDouble(medicinePriceParam)), Integer.parseInt(medicineStatusParam));
