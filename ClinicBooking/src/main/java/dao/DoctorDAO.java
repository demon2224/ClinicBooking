...
//     */
//    public List<DoctorDTO> searchDoctors(String searchName, String specialtyName, Integer jobStatusId,
...
//        String sql = "SELECT dr.DoctorReviewID, dr.PatientID, dr.DoctorID, dr.Content, dr.RateScore, dr.DateCreate, "
//                + "pt.FirstName AS PatientFirstName, pt.LastName AS PatientLastName, pt.Avatar AS PatientAvatar "
...
//     * @return a list of DoctorDegree objects representing the doctor's degrees, or
//     *         an
